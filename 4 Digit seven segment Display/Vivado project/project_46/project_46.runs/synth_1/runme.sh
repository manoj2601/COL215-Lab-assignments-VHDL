...
HD_PWD='/home/dual/cs5180411/Desktop/Assignment 4 using assign3 real/project_46/project_46.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log assign4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source assign4.tcl
