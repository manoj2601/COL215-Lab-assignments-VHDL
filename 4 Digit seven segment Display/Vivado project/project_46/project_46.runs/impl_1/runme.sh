...
HD_PWD='/home/dual/cs5180411/Desktop/Assignment 4 using assign3 real/project_46/project_46.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log assign4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source assign4.tcl -notrace
